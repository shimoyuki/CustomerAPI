...
public class DataTablePageUtil<T> {
	...
	public DataTablePageUtil(HttpServletRequest request) {
		...
		this.setOrder(new int[] {Integer.parseInt(request.getParameter("order[0][column]"))});
		this.setOrder_dir(request.getParameter("order[0][dir]"));
